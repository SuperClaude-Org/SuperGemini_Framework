...
setuptools.setup(
    ...
    description="Framework that extends Gemini CLI with specialized commands, personas, and MCP server integration",
    ...
    keywords="gemini cli framework development automation mcp personas commands workflow",
    entry_points={
        "console_scripts": [
    ...
    project_urls={
        ...
        "Documentation": "https://github.com/SuperGemini-Org/SuperGemini_Framework/blob/master/Docs/supergemini-user-guide.md",
        "Bug Tracker": "https://github.com/SuperGemini-Org/SuperGemini_Framework/issues",
        "Changelog": "https://github.com/SuperGemini-Org/SuperGemini_Framework/releases",
    },
    classifiers=[
