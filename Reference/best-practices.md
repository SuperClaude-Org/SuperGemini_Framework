...
/sg:analyze . --seq --all-mcp     # Advanced analysis
/sg:implement "enterprise project" --orchestrate  # Complex coordination
```
...
/sg:implement "multi-service architecture"         # Task management mode
...
/sg:implement "complex system development" --orchestrate
...
/sg:analyze . --seq --focus security --depth deep --export report
# --seq: Structured analysis with systematic reasoning
...
/sg:implement "full-stack platform with React, Node.js, PostgreSQL, Redis, Docker deployment"
...
/sg:implement "frontend-backend integration with testing and deployment"
...
/sg:implement "microservices deployment with monitoring and security"
...
/sg:implement "complex project" --orchestrate --scope project
...
/sg:analyze distributed-system/ --seq --all-mcp --comprehensive
...
/sg:implement "enterprise platform development" --multi-team --coordination-matrix
...
✅ /sg:implement "improve codebase quality" --orchestrate (multi-agent, fast)
```
